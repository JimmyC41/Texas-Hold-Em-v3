...
protected:
    ...
    DealTest()
        ...
        player1("P1", Position::SMALL_BLIND, 500),
        player2("P2", Position::BIG_BLIND, 500),
        player3("P3", Position::UTG, 500),
        player4("P4", Position::UTG_1, 500) {}
...
bool allUniqueCards(const std::vector<Card>& cards) {
    ...
    cout << "Set size: " << uniqueCards.size() << " and dealt cards size: " << cards.size() << endl;
